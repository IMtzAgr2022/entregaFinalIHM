...
<head>
    ...
    <script>
        ...
        function validateNoCuenta() {
            ...
            if (!/^\d{5}$/.test(noCuenta)) {
                alert("El número de cuenta debe contener exactamente 5 números enteros.");
                noCuentaInput.value = "";
                return false;
            }
        ...
        function validateIdTarjeta() {
            ...
            if (!/^[A-Za-z0-9]{1,8}$/.test(idTarjeta)) {
                alert("El identificador de tarjeta debe contener únicamente letras y números, y tener una longitud máxima de 8 caracteres.");
